<?php include "includes/header.inc.php"; ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="text-center text-white">
                            <!-- Page heading-->
                            <h1 class="mb-5">Find Out How Much Importing Your JDM Dream Car Really Costs</h1>
        ...
        <section class="showcase">
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('http://jdmimporter.com/wp-content/uploads/2019/12/61038217_402658523912675_1554310460688302080_n.jpg')"></div>
                ...
                <div class="row g-0">
                    <div class="col-lg-6 text-white showcase-img" style="background-image: url('http://jdmimporter.com/wp-content/uploads/2019/12/IMG_7585-scaled.jpg')"></div>
